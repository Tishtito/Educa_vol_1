...
<section class="courses">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="subjects/cre.php" class="inline-btn">Enter Marks</a>
      </div>

      <div class="box">
   
         <div class="thumb">
            <img src="photos/agriculture.jpg" alt="">
         </div>
         <h3 class="title">Agriculture & Nutrition</h3>
         <a href="subjects/agricnutri.php" class="inline-btn">Enter Marks</a>
      </div>
      ...
      <div class="box">
         ...
         <a href="subjects/scitech.php" class="inline-btn">Enter Marks</a>
      </div>
      ...
      <div class="box">
         ...
         <h3 class="title">SST</h3>
         <a href="subjects/sst.php" class="inline-btn">Enter Marks</a>
      </div>
...
<section class="home-grid">
   ...
   <div class="box-container">
     <div class="box">
         ...
         <p class="likes">SST : <span><?php echo $sst_mean; ?></span></p>

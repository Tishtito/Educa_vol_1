        ...
        echo "<script>
            setTimeout(function() {
                swal({
                    ...
                    window.location.href = '../subjects/cre.php?. exam_id=" . urlencode($_SESSION['exam_id']) . "';
                });
            }, 100);
        </script>";
        exit;
        ...
        <?php endif; ?>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-3 d-grid">
                    <a class="btn btn-outline-primary mb-2" href="../subjects/cre.php" role="button">Cancel</a>
                </div>
            </div>
        </form>
    </div>

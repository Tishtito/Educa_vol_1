<?php
    ...
    $query = "SELECT name FROM users WHERE class_assigned = ?";
    $stmt = $conn->prepare($query);
    ...
    $subjects = [
        ...
        'AgricNutri' => 'Agriculture & Nutritions',
            ...
            <header>
                <div class="row">
                    ...
                    <div class="col company-details">
                        <h2 class="name">
                            <a target="_blank" href="">
                            DEB GATIMU PRIMARY AND JUNIOR SCHOOL
                            </a>
                        </h2>
                        <div style="font-size:30px">PO BOX 141-00217</div>
                        <div style="font-size:30px">Debgatimuprimary@gmail.com</div>
                    </div>
                </div>
            </header>
            <main>
                ...
                <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tfoot>
                        <tr>
                            <td></td>
                            <td>TOTAL MARK</td>
                            <td><?php echo $total_marks; ?> /800</td>
                        </tr>
                    </tfoot>

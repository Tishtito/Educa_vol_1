    ...
    if ($connection->connect_error) {
     ...
     // SQL query to calculate the mean score for each subject across grade_1, grade_2, and grade_3
        ...
        SELECT 
            exams.exam_name AS exam_id,
            students.class AS grade,
            'AgricNutri' AS subject,
            AVG(COALESCE(exam_results.AgricNutri, 0)) AS mean_score,
            COUNT(DISTINCT students.student_id) AS total_students
        FROM 
            students
        LEFT JOIN 
        ...
        SELECT 
            ...
            students.class AS grade,
            'CRE' AS subject,
            AVG(COALESCE(exam_results.CRE, 0)) AS mean_score,
            COUNT(DISTINCT students.student_id) AS total_students
        FROM 
            students
        LEFT JOIN 
        ...
        SELECT 
            ...
            students.class AS grade,
            'SST' AS subject,
            AVG(COALESCE(exam_results.SST, 0)) AS mean_score,
            COUNT(DISTINCT students.student_id) AS total_students
        FROM 
            students
        LEFT JOIN 
        ...
        SELECT 
            ...
            students.class AS grade,
            'SciTech' AS subject,
            AVG(COALESCE(exam_results.SciTech, 0)) AS mean_score,
            COUNT(DISTINCT students.student_id) AS total_students
        FROM 
            students
        LEFT JOIN 

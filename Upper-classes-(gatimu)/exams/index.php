...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT id, username, password, class_assigned FROM users WHERE username = ?";
    ...
    <div class="container">
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" class="mx-auto">
            ...
            <div class="brand-logo">
                <img src="photos/logo.png" width="160px" height="140px">
            </div>
            <div class="brand-title">Ngure Primary</div>
            <div class="inputs">
                ...
                <input type="password" placeholder="*******" name="password" class="form-control <?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?>"/>

   ...
   <?php
      ...
      if ($_SESSION['marks_out_of7'] === null) {
         ...
         if ($row = $res->fetch_assoc()) {
            $_SESSION['marks_out_of7'] = $row['marks_out_of'];
         }
         $stmt->close();
      }

      if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['set_marks_out_of7'])) {
         $_SESSION['marks_out_of7'] = (int) $_POST['marks_out_of7'];
               ...
               <?php if ($result->num_rows > 0): ?>
                  <?php while ($row = $result->fetch_assoc()): ?>
                     <tr>
                        ...
                        <td>
                           <a class="option-btn" href="../editmarks/editsst.php?student_class_id=<?= $row['student_class_id'] ?>">
                              Edit
                           </a>
                        </td>
                     </tr>

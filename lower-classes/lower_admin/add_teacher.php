...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($name_err) && empty($username_err) && empty($password_err) && empty($confirm_password_err) && empty($class_err)){
        ...
        $sql = "INSERT INTO users (name, username, password, class_assigned) VALUES (?, ?, ?, ?)";
            ...
            <div class="class-box">
                ...
                <div class="class-options">
                    <div class="class">
                        ...
                        <input type="radio" name="class" value="1_blue" checked/>
                    </div>

                    <div class="class">
                        <label for="male">1 Red</label>
                        <input type="radio" name="class" value="1_red" checked/>
                    </div>

                    <div class="class">
                        <label for="female">2 Blue</label>
                        <input type="radio" name="class" value="2_blue" checked/>
                    </div>
                    
                    <div class="class">
                        <label for="female">2 Red</label>
                        <input type="radio" name="class" value="2_red" checked/>
                    </div>

                    <div class="class">
                        <label for="female">3 Blue</label>
                        <input type="radio" name="class" value="3_blue" checked/>
                    </div>
                    
                    <div class="class">
                        <label for="female">3 Red</label>
                        <input type="radio" name="class" value="3_red" checked/>
                    </div> 
                </div>
            </div>

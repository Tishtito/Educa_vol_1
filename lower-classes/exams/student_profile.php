...
<section class="teacher-profile">
   ...
   <div class="details">
      ...
      <p><b>Total Marks:</b> 
         <?php 
            $total_marks = $student['Math'] + $student['English'] + $student['Kiswahili'] + $student['Creative'] + $student['Religious'] + $student['Enviromental'];
...
<section class="marks">
   ...
   <div class="box-container">
      ...
      <div class="box">
        ...
        <p><b>Environmental:</b><span><?php echo htmlspecialchars($student['Enviromental'] ?? '-'); ?></span></p>
      </div>

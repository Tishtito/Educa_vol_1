...
<div class="side-bar">
   ...
   <nav class="navbar">
      ...
      <a href="https://upperclassteacher.nguresch.xyz/exam.php"><i class="fas fa-chalkboard-teacher"></i><span>Class-Teacher Portal</span></a>
   </nav>
...
<section class="marks-table">
   <h1 class="heading">social Studies</h1>
   <?php
      ...
      if (isset($_POST['set_marks_out_of7'])) {
         $_SESSION['marks_out_of7'] = intval($_POST['marks_out_of7']); // Store the new value
   ...
   <form method="post">
      <h2>Marks out of: 
         <input type="number" name="marks_out_of7" value="<?php echo $_SESSION['marks_out_of7']; ?>" required>

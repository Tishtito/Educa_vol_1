...
<section class="marks-table">
   ...
   <?php
      ...
      if (isset($_POST['set_marks_out_of'])) {
         $_SESSION['marks_out_of'] = intval($_POST['marks_out_of']); // Store the new value
   ...
   <form method="post">
      <h2>Marks out of: 
         <input type="number" name="marks_out_of" value="<?php echo $_SESSION['marks_out_of']; ?>" required>

...
<body>
                            ...
                            <?php if ($result && mysqli_num_rows($result) > 0): ?>
                                <?php while ($row = mysqli_fetch_assoc($result)): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="delete-link1" data-id="<?php echo htmlspecialchars($row['examiner_id']); ?>">
    ...
    <script>
        ...
        document.querySelectorAll('.delete-link1').forEach(function(link) {
            link.addEventListener('click', function(event) {
                event.preventDefault(); // Prevent default link behavior
                ...
                swal({
                    ...
                    if (isConfirmed) {
                        // Redirect to the delete page if confirmed
                        window.location.href = "delete_examiner.php?id=" + examinerId;
                    }
                });
            });
        });

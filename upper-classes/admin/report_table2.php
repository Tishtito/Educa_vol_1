                        ...
                        <tbody>
                            <?php foreach ($students as $student): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="report_form1.php?student_id=<?php echo $student['student_id']; ?>&exam_id=<?php echo $exam_id; ?>&exam_type=<?php echo urlencode($exam_type); ?>">
    ...
    <script>
        document.getElementById("printAll").addEventListener("click", function () {
            ...
            students.forEach(student => {
                content += '<iframe src="report_form1.php?student_id=' + student.student_id + '&exam_id=' + examId + '&exam_type=' + examtype +'" style="width:100%; height:1550px; border:0;"></iframe>';

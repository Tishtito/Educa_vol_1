...
// Fetch years when students were marked as Finished
$sql = "SELECT DISTINCT YEAR(finished_at) AS finished_year
        FROM students
        WHERE status = 'Finished'
          AND updated_at IS NOT NULL
        ORDER BY finished_year DESC";
    ...
    <div class="content">
        ...
        <main>
            ...
            <?php foreach ($years as $year): ?>
                <a href="students_finished_by_year.php?year=<?php echo $year; ?>">
                    <li>

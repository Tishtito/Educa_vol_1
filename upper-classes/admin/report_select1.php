    ...
    <div class="content">
        ...
        <main>
            ...
            <?php foreach ($grades as $grade): ?>
                <a href="report_table1.php?exam_id=<?php echo urlencode($exam_id); ?>&grade=<?php echo urlencode($grade); ?>&exam_type=<?php echo urlencode($exam_type); ?>">
                    <li>

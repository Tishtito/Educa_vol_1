...
<section class="marks-table">
   ...
   <?php
      ...
      if (isset($_POST['set_marks_out_of5'])) {
         $_SESSION['marks_out_of5'] = intval($_POST['marks_out_of5']); // Store the new value
   ...
   <form method="post">
      <h2>Marks out of: 
         <input type="number" name="marks_out_of5" value="<?php echo $_SESSION['marks_out_of5']; ?>" required>

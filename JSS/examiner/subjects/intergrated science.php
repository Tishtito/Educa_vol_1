...
<section class="marks-table">
   ...
   <?php
      ...
      if (isset($_POST['set_marks_out_of6'])) {
         $_SESSION['marks_out_of6'] = intval($_POST['marks_out_of6']); // Store the new value
   ...
   <form method="post">
      <h2>Marks out of: 
         <input type="number" name="marks_out_of6" value="<?php echo $_SESSION['marks_out_of6']; ?>" required>
               ...
               <?php if ($result->num_rows > 0): ?>
                  <?php while ($row = $result->fetch_assoc()): ?>
                     <tr>
                        ...
                        <td>
                           <a class="option-btn" href="../editmarks/editsci.php?student_id=<?php echo htmlspecialchars($row['student_id']); ?>&exam_id=<?php echo htmlspecialchars($exam_id); ?>">
                              Edit
                           </a>
                        </td>
                     </tr>

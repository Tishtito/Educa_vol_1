...
<section class="marks-table">
   ...
   <?php
      ...
      if (isset($_POST['set_marks_out_of3'])) {
         $_SESSION['marks_out_of3'] = intval($_POST['marks_out_of3']); // Store the new value
   ...
   <form method="post">
      <h2>Marks out of: 
         <input type="number" name="marks_out_of3" value="<?php echo $_SESSION['marks_out_of3']; ?>" required>

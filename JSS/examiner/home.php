...
<?php
   ...
   $subject_details = [
      ...
      "creative arts" => ["image" => "photos/creative.jpg"],
      "religious" => ["image" => "photos/religious.jpg"],
      "intergrated science" => ["image" => "photos/science.png"],
      "social studies" => ["image" => "photos/sst.png"],
      "pre-technical" => ["image" => "photos/technical.jpg"],
      "agriculture" => ["image" => "photos/agriculture.jpg"]
   ];
?>

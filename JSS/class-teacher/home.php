<?php
   ...
   $religious_mean = $means['Religious'];
   $agriculture_mean = $means['Agriculture'];
   $technical_mean = $means['Technical'];
   $sst_mean = $means['SST'];
   $science_mean = $means['Science'];
...
<section class="home-grid">
   ...
   <div class="box-container">
     <div class="box">
         ...
         <p class="likes">Agriculture : <span><?php echo $agriculture_mean; ?></span></p>
         <p class="likes">Pre-technical : <span><?php echo $technical_mean; ?></span></p>
         <p class="likes">Social studies : <span><?php echo $sst_mean; ?></span></p>
         <p class="likes">Intergrated science : <span><?php echo $science_mean; ?></span></p>
...
<section class="courses">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="subjects/technical.php" class="inline-btn">View Marks</a>
      </div>

...
<section class="teacher-profile">
   ...
   <div class="details">
      ...
      <p><b>Total Marks:</b> 
         <?php 
            $total_marks = $student['Math'] + $student['English'] + $student['Kiswahili'] + $student['Creative'] + $student['Religious'] + $student['Agriculture'] + $student['SST'] + $student['Technical'] + $student['Science'];
...
<section class="marks">
   ...
   <div class="box-container">
      ...
      <div class="box">
        ...
        <p><b>Religious:</b><span><?php echo htmlspecialchars($student['Religious'] ?? '-'); ?></span></p>
        <p><b>Agriculture:</b><span><?php echo htmlspecialchars($student['Agriculture'] ?? '-'); ?></span></p>
        <p><b>SST:</b><span><?php echo htmlspecialchars($student['SST'] ?? '-'); ?></span></p>
        <p><b>Pre-Technical:</b><span><?php echo htmlspecialchars($student['Technical'] ?? '-'); ?></span></p>
        <p><b>Science:</b><span><?php echo htmlspecialchars($student['Science'] ?? '-'); ?></span></p>
      </div>

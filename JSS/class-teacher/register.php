...
<div class="side-bar">
   ...
   <nav class="navbar">
      ...
      <a href="points_table.php"><i class="fas fa-thumbtack"></i><span>Points</span></a>
   </nav>
   ...
   <?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($stmt->execute()) {
            ...
            $insertExamResults = "INSERT INTO exam_results (student_id, exam_id, English, Kiswahili, Math, Creative, Religious, Agriculture, SST, Technical, Science)

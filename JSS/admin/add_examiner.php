        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="class-box">
                ...
                <label class="class" for="creative arts">Creative Arts
                    ...
                    <label class="class" for="pre-technical">Pre-Technical
                        <input type="checkbox" id="pre-technical" name="subjects[]" value="pre-technical"/>
                        <span class="checkmark"></span>
                    </label>
                    
                    <label class="class" for="agriculture">Agriculture
                        <input type="checkbox" id="agriculture" name="subjects[]" value="agriculture"/>
                        <span class="checkmark"></span>
                    </label>
                </div>

                <div class="class-subjects">
                <label class="class" for="religious">Religious
                        <input type="checkbox" id="religious" name="subjects[]" value="religious"/>
                        <span class="checkmark"></span>
                    </label>
                    ...
                    <label class="class" for="intergrated science">Intergrated Science
                        <input type="checkbox" id="intergrated science" name="subjects[]" value="intergrated science">
                        <span class="checkmark"></span>
                    </label> 
                </div>
            </div>

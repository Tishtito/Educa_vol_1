                    ...
                    <table>
                        ...
                        <?php
                            ...
                            while ($row = $result->fetch_assoc()) {
                                echo "<tr>
                                        <td><p>" . htmlspecialchars($row['exam_name']) . "</p></td>
                                        <td><a href='#' class='delete-link' data-id='" . htmlspecialchars($row['exam_id']) . "'><span class='status delete'>delete</span></a></td>                                    </tr>";
                            }
                            ?>
                        </tbody>
                    </table>
        ...
        link.addEventListener('click', function(event) {
            ...
            swal({
                ...
                if (isConfirmed) {
                    ...
                    window.location.href = "delete_exam.php?id=" + classId;
                }
            });
        });
    });

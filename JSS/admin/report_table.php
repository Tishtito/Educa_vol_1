            ...
            <div class="bottom-data">
                <div class="orders">
                    <div class="header">
                        ...
                        <h3>Students</h3>
                        <a href="download_reports.php?grade=<?php echo urlencode($class); ?>&exam_id=<?php echo $exam_id; ?>" class="download-all" id="downloadAll">
                        ...
                        <tbody>
                            <?php $counter = 1; foreach ($students as $student): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="new_report.php?student_id=<?php echo $student['student_id']; ?>&exam_id=<?php echo $exam_id; ?>" class="view-report">

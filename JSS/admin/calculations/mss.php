    ...
    foreach ($grades as $grade) {
        ...
        $sql = "
            SELECT 
                ...
                COALESCE(Creative, 0) + COALESCE(Religious, 0) + COALESCE(Agriculture, 0) + COALESCE(SST, 0) + COALESCE(Technical, 0) + COALESCE(Science, 0)) / COUNT(exam_results.student_id)) AS MeanScore 
            FROM exam_results
